...
for tol=tols
  ...
  fx = 1
  tic; 
  [sol iter_count, is_converge, norm_grad] = steepest_descent(@a, [1,2] ,1000, tol);
  elapsed_time = toc;
  ...
  fx = fx + 1 
  tic; 
  [sol iter_count, is_converge, norm_grad] = steepest_descent(@b, [1,1,-0.5] ,1000, tol);
  elapsed_time = toc;
  Res = [Res ; [fx, iter_count, tol, is_converge, elapsed_time, norm_grad] ];
  sol2 = [sol2 ; sol];
  ...
  for i = n_power
    ...
    fx = fx + 1
    tic;
    [sol iter_count, is_converge, norm_grad] = steepest_descent(@c, temp, 1000, tol);
    elapsed_time = toc;
    Res = [Res ; [fx, iter_count, tol, is_converge, elapsed_time, norm_grad] ];
    if (fx == 3)
      sol3 = [sol3 ; sol];
